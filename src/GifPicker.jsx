...
const TENOR_KEY = 'AIzaSyAyImkuYQYF_FXVALexPuGQctUMRURdCHQ' // Google public Tenor API key
...
function GifPicker({ onSelect, onClose }) {
  ...
  return (
    <div className="flex flex-col w-full sm:w-80 h-72 sm:h-96 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl overflow-hidden">
      {/* Header */}
          ...
          <div className="grid grid-cols-2 gap-1.5">
            {gifs.map(gif => (
              <button
                ...
                className="relative aspect-video rounded-lg overflow-hidden bg-slate-700 hover:ring-2 hover:ring-indigo-500 transition-all group"
              >
                <img
